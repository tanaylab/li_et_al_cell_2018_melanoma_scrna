...
* Raw UMI counts for all cells with metacell membership information: [Li2018_umi_counts.tar.gz](https://schic2.s3.eu-west-1.amazonaws.com/Li2018/Li2018_umi_counts.tar.gz). This gzipped archive contains a gene-cells UMI table in matrix-market format and a metadata table per cell. The metadata table also contains the metacell membership and the annotated group per metacell model - all cells, T/NK cells and non-T/NK cells.
