...
* Raw UMI counts for all cells: [Li2018_umi_counts.tar.gz](http://www.wisdom.weizmann.ac.il/~lubling/Li2018/Li2018_umi_counts.tar.gz) (a gzipped archive with gene-cells UMI table in matrix-market format and with a metadata table per cell. Note that metacell assignments are supplied in Table 3 in the online version of the [paper](https://www.cell.com/cell/fulltext/S0092-8674(18)31568-X)).
